/**
 * Document Processing API Route with Server-Sent Events (SSE)
 *
 * Purpose: Processes uploaded documents into vector embeddings with real-time progress streaming
 *
 * Features:
 * - Proper SSE implementation with heartbeat mechanism
 ...
 * Each event: data: {JSON object with progress update}\n\n
 *
 * SSE Events:
